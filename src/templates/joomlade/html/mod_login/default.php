		...
		<div id="form-login-username" class="form-group">
			<?php if (!$params->get('usetext')) : ?>
				<div class="input-group">
					...
					<input id="modlgn-username" type="text" name="username" class="form-control" style="color:#000" tabindex="0" size="18" placeholder="<?php echo JText::_('MOD_LOGIN_VALUE_USERNAME') ?>" />
				</div>
			<?php else: ?>
		...
		<div id="form-login-secretkey" class="form-group">
			<?php if (!$params->get('usetext')) : ?>
				<div class="input-group">
					...
					<input id="modlgn-secretkey" autocomplete="off" type="text" name="secretkey" style="color:#000" class="form-control" tabindex="0" size="18" placeholder="<?php echo JText::_('JGLOBAL_SECRETKEY') ?>" />
			...
			<?php else: ?>
				...
				<input id="modlgn-secretkey" autocomplete="off" type="text" name="secretkey" style="color:#000" class="input-small" tabindex="0" size="18" placeholder="<?php echo JText::_('JGLOBAL_SECRETKEY') ?>" />
