...
if ($this->countModules('sidebar-a')) $contentclass = $params->get('content-2-col-a','col-md-8');
if ($this->countModules('sidebar-b')) $contentclass = $params->get('content-2-col-b','col-md-8');
if ($this->countModules('sidebar-a') and $this->countModules('sidebar-b'))
{
	$contentclass = $params->get('content-3-col','col-md-4');
	$sidebar_a = $params->get('sidebar-a-3-col','col-md-4');
	$sidebar_b = $params->get('sidebar-b-3-col','col-md-4');
}
